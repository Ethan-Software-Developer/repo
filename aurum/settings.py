"""
Django settings for aurum project.
...
SECRET_KEY = 'django-insecure-l#=)yhq95y8x(*(e$5%-5gd3-gct9e@$$j%pz!r#!c)o%xhaeb'
...
WSGI_APPLICATION = 'aurum.wsgi.application'
...
STATICFILES_DIRS = [
    BASE_DIR / "global_static",  # Global static directory for custom static files
]
